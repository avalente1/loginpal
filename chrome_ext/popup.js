...
infoHTML+= "<tr class='rowhover'><td class='company'>" + "<a href='http://www." + websiteDetails.site + "'" + "target='_blank'" + ">" + '<img src=' + websiteDetails.favicon + '> ' + websiteDetails.company + "</a>"  + "</td>"
